...
namespace ReadAllLibrary.ASPSMSX2 {
    ...
    public interface ASPSMSX2Soap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ReadAllLibrary.ASPSMSX2.vouchers[] GetVoucherTransactions(string UserKey, string Password);
        
        [System.ServiceModel.OperationContractAttribute(Action="https://webservice.aspsms.com/aspsmsx2.asmx/GetVoucherTransactions", ReplyAction="*")]
        System.Threading.Tasks.Task<ReadAllLibrary.ASPSMSX2.vouchers[]> GetVoucherTransactionsAsync(string UserKey, string Password);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ASPSMSX2SoapChannel : ReadAllLibrary.ASPSMSX2.ASPSMSX2Soap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ASPSMSX2SoapClient : System.ServiceModel.ClientBase<ReadAllLibrary.ASPSMSX2.ASPSMSX2Soap>, ReadAllLibrary.ASPSMSX2.ASPSMSX2Soap {
        ...
        public ReadAllLibrary.ASPSMSX2.vouchers[] GetVoucherTransactions(string UserKey, string Password) {
            return base.Channel.GetVoucherTransactions(UserKey, Password);
        }
        
        public System.Threading.Tasks.Task<ReadAllLibrary.ASPSMSX2.vouchers[]> GetVoucherTransactionsAsync(string UserKey, string Password) {
